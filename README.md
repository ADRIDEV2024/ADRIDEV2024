...
¡Bienvenido a mi portfolio!🙋‍♂️ Mi nombre es Adrian, vivo en España y soy un desarrollador backend autodidacta que ha trabajado durante varios años tanto de forma independiente como en un equipo altamente profesional, consolidando algunas de las más importantes habilidades y técnicas como programador para contribuir en la puesta en marcha de proyectos TI emocionantes tanto pequeños como de tamaño mediano. Python es el mejor lenguaje para mí en este momento, y he desarrollado algunas apps básicas de Python y otras un poco más complejas, algunas de ellas los verás en mis repositorios de Github. La programación es la mejor práctica para relajarme y aprender cosas maravillosas💻. Te invito a echar un vistazo a mis proyectos si eres un gran programador😎❤.

Welcome to my portfolio!🙋‍♂️ My name is Adrian,I live in Spain and I´m an autodidact backend programmer that worked along some years as freelance but also within a great professional tech team, where I have consolidated some of my skills and techniques as a programmer, setting in motion exciting little and mid-size IT projects. Python is the best language for me at this moment, and I developed some basic Python apps and some others medium level projects. You will see them in my Github repositories.
...
![NODE](https://img.shields.io/badge/nodejs-%1F6FEB.svg?style=for-the-badge&logo=nodejs&logoColor=cian)
